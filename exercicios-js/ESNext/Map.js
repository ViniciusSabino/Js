...
// 1 - Não aceita repetição na chave (Caso a funçã set se repita ela irá substituir o 
// valor e manter a mesma chave, sem repetição)
...
// True => Retornará um booleano indicando se o valor está ou não contido nesse Map

console.log(chavesVariadas.has(1234)); // False

chavesVariadas.delete(123); 
// Deletando um valor que está contido dentro do Map (Retorna true ou false se conseguiu ou não deletar)
