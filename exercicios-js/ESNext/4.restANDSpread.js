...
const cloneFuncionario = { ativo: true, ...funcionario }; // Criando um novo objeto com o atributo ativo mais todos os atributos do objeto funcionario
...
const grupoFinal = ["Anderson", "Rayza", ...grupoA]; // Espalhando todos os elementos do array grupoA dentro do array grupoFinal
