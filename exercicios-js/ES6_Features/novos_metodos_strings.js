...
// (Indico a partir de qual caractere devo iniciar a busca)
console.log(time.startsWith("Paulo", 4)); // true
...
// (Indico até qual caractere ele deve contar)
console.log(time.endsWith("Paulo", 9)); // true 
